...
#
# 或从macOS通过SSH:
#   ssh ljz@localhost -p 2222 'sudo bash -s' < scripts/postinstall-openkylin.sh
...
echo ""
echo "下一步:"
echo "  1. 关机: sudo shutdown now"
echo "  2. 用Lima启动: limactl start docker/lima-openkylin.yaml"
echo "  3. 登录: limactl shell openkylin"
echo "  4. 进入项目目录运行诊断工具"
echo ""